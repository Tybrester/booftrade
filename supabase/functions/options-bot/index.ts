...
const corsHeaders = { 'Access-Control-Allow-Origin': 'https://boofcapital.com, https://www.boofcapital.com', 'Access-Control-Allow-Headers': 'authorization, x-client-info, apikey, content-type', 'Access-Control-Allow-Methods': 'POST, OPTIONS' };
